import { DescriptorProto, EnumDescriptorProto, FieldDescriptorProto, FieldOptions_JSType, MethodDescriptorProto, ServiceDescriptorProto, } from "@protobuf-ts/plugin-framework";
...
export class Interpreter {
    ...
    readOptions(descriptor, excludeOptions = []) {
        ...
        if (FieldDescriptorProto.is(descriptor) &&
            DescriptorProto.is(this.registry.parentOf(descriptor))) {
